...
function Detial() {
  return (
    <>
      <section className='app__detial mx-auto z-10'>
        {/* title */}
        <div className='app__detial-title '> 
          <div className='pt-8'>
        ...
        {/* photo wall */}
        <div className='app__detial-photoBox max-w-6xl  mx-auto overflow-hidden mt-8'>
            {/* <div class="grid grid-cols-12 grid-rows-12 app__detial-photoWall "> */}
            <div class="app__detial-photoWall ">
